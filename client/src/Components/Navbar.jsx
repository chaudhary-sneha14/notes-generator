        ...
        <div className="flex items-center gap-4 relative">
          ...
          <div ref={creditsRef} className="relative">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 px-4 py-2 rounded-full bg-linear-to-r from-purple-500/20 to-blue-500/20 border border-black/20 text-white text-sm cursor-pointer hover:shadow-lg transition-all duration-300"
            >
              <span>💎</span>
            ...
            <Dropdown isOpen={showCredits}>
              ...
              <button
                className="w-full py-2 rounded-lg bg-linear-to-r from-purple-500 to-blue-500 text-white font-semibold hover:opacity-90 transition"
                onClick={() => {
                  setShowCredits(false);
                  navigate("/pricing");
                }}
          ...
          <div ref={profileRef} className="relative">
            <motion.div
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="w-10 h-10 flex items-center justify-center rounded-full bg-linear-to-r from-purple-500 to-blue-500 text-white font-semibold cursor-pointer shadow-md"
            >
              {userInitial}
            </motion.div>
