...
const Home = () => {
  ...
  return (
    <div className="bg-linear-to-br
     from-slate-50 via-white to-slate-100 min-h-screen">
      <Navbar />
      ...
      <section className="max-w-7xl mx-auto px-6 lg:px-8 pt-16 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <h1 className="text-5xl lg:text-6xl font-extrabold leading-tight bg-linear-to-r
           from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent">
          ...
          <div className="mt-10 flex gap-4">
            <motion.button onClick={()=>navigate('/note')}
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3 rounded-xl bg-linear-to-r from-blue-600 to-purple-600 text-white font-semibold shadow-lg hover:shadow-xl transition-all cursor-pointer"
            >
              Get Started
            </motion.button>
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute -inset-4 bg-linear-to-r from-blue-400 to-purple-500 rounded-3xl blur-3xl opacity-20"></div>
          <img
            src={book}
            alt="Hero"
