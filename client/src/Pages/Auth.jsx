...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-white text-black px-8">
      ...
      {/* //_______________main________________________ */}
      ...
      <main className="max-w-7xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
       ...
       bg-clip-text text-transparent"
          ...
          onClick={handleGoogleAuth}
            ...
            className="mt-10 px-10 py-3 rounded-xl flex items-center gap-3 bg-linear-to-r from-blue-500 to-purple-600 text-white font-semibold hover:from-blue-600 hover:to-purple-700 transition-colors duration-300 cursor-pointer"
          >
          ...
          <p className="mt-6 max-w-xl text-lg bg-linear-to-br from-gray-700 via gray-500/80 to-gray-700 bg-clip-text text-transparent">
            ...
            create exam notes,charts ,graph, and download clean PDFs- instantly
            using AI.
          </p>

          <p className="mt-4 text-sm text-gray-500">
            Start with 50 FREE credits ,Upgrades anytime for more credits
            ,Instant access
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          <Feature
            ...
            desc="Easily upgrade for more credits and enhanced features whenever you need."
          />
          <Feature
            icon="🔒"
            title="Secure Access"
            desc="Enjoy secure and instant access to your AI-generated notes and resources."
          />
          <Feature
            icon="⬇️"
            title="Free download"
...
function Feature({ icon, title, desc }) {
  return (
    <motion.div
      whileHover={{ y: 12, rotateX: 0, rotateY: -8, scale1: 1.05 }}
      transition={{ type: "spring", stiffness: 200, damping: 18 }}
      className="relative rounded-2xl p-6 bg-linear-to-br from-black/90 via-balck/80 to-black/90 border border-white/10 text-white"
